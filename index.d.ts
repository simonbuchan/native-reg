...
export declare const HKCR: HKEY;
export declare const HKCU: HKEY;
export declare const HKLM: HKEY;
export declare const HKU: HKEY;
...
export declare function enumKeys(hkey: HKEY): string[];
export declare function enumValues(hkey: HKEY): string[];
export declare type Value<Type extends ValueType = ValueType> = Buffer & {
    type: Type;
};
...
export declare function deleteKey(hkey: HKEY, subKey: string): void;
export declare function deleteTree(hkey: HKEY, subKey: string): void;
export declare function deleteKeyValue(hkey: HKEY, subKey: string, valueName: string): void;
export declare function deleteValue(hkey: HKEY, valueName: string): void;
